...
| 段階 | 内容 | 状態 |
|---|---|---|
| **Phase 0** | 1人 + 台帳 (main developer + reviewer 1 + CI gate + 証拠錨) | ここ |
| Phase 1 | 5 ロール + capability hook + 敵対的 Verifier + 4 種停止条件 | 予定 (台帳 P6) |
| Phase 2 | orchestrator loop + Automations (discover→enqueue) | 予定 (台帳 P7) |

※ 成熟度の Phase 0/1/2 と、制約強度の L1–L4 (Rules / Skill / Hook・CI / 構造テスト) は別の軸。
